...
<section class="contact_area p_100">
    <div class="container">
        ...
        <div class="contact_form_inner">
            ...
            <form class="contact_us_form row" action="{{ route('contacts.contact.store') }}" method="post" id="contactForm" novalidate="novalidate">
                {{ csrf_field() }}
                ...
                <div class="form-group col-lg-12">
                    <textarea class="form-control" name="content" id="message" rows="1" placeholder="Type Your Message..." required></textarea>
                </div>
                <div class="form-group col-lg-12">
