...
Credit Requests        </h1>
    ...
    <section class="content col-md-8">
        ...
        <div class="box box-default col-md-offset-2  col-md-6" >
            ...
            <form method="POST" action="{{ route('credit_requests.credit_request.update', $creditRequest->id) }}" id="edit_credit_request_form" name="edit_credit_request_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
