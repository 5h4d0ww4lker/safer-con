                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="ctown" name="region" required>
                                    <option value="{{$address->region}}" selected>{{$address->region}}
                                    <option>
                        ...
                        <label for="name">City <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="city" id="name" class="form-control" value="{{ $address->city }}" placeholder="Enter city.." required>
                                @if ($errors->has('name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <label for="name">Sub City <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="sub_city" id="name" class="form-control" value="{{ $address->sub_city }}" placeholder="Enter sub city.." required>
                                @if ($errors->has('name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span>
                        ...
                        <label for="name">Location <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="location" id="name" class="form-control" value="{{ $address->location }}" placeholder="Enter location.." required>
                                @if ($errors->has('name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <label for="name">Phone No <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="phone_number_1" id="name" class="form-control" value="{{ $address->phone_number_1 }}" placeholder="Enter phone_number.." required>
                                @if ($errors->has('name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <label for="name">Building <span class="text-danger">*</span></label>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="building" id="name" class="form-control" value="{{ $address->building }}" placeholder="Enter building.." required>
                                @if ($errors->has('name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('name') }}</strong>
                                </span>
