                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('employee_id') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="employee_id" id="employee_id" class="form-control" value="{{ $employee['employee_id'] }}" placeholder="Enter employee id..">
                            ...
                            <div class="form-group{{ $errors->has('mother_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="mother_name" id="mother_name" class="form-control" value="{{ $employee['mother_name'] }}" placeholder="Enter mother's name..">
                            ...
                            <div class="form-group{{ $errors->has('contact_no_one') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control" value="{{ $employee['contact_no_one'] }}" placeholder="Enter contact no..">
                           ...
                           <a href="{{ url('/public/cv/' . $employee['cv']) }}">Download CV</a>
