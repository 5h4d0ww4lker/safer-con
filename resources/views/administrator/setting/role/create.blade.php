        ...
        <div class="box box-default">
            ...
            <form action="{{route('setting.role.store')}}" method="post" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Enter role name..">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('display_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="display_name" id="display_name" class="form-control" value="{{ old('display_name') }}" placeholder="Enter display name..">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="description" id="description" class="form-control" value="{{ old('description') }}" placeholder="Enter display name..">
               ...
               <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Create Role</button>
            </div>
        </form>
    </div>
    <!-- /.box -->
