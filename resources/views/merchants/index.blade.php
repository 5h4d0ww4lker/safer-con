...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <a href="{{ route('merchants.merchant.create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add </a>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('merchants.merchant.show', $merchant->id ) }}" class="btn btn-info" title="Show Merchant">
